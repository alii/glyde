...
import glyde/id
import glyde/model/application_command
...
pub type Interaction {
  Interaction(
    ...
    /// `glyde/api/interaction.responding_to` rather than reading it out.
...
/// `glyde/model/component`'s, so there is one table of it.
fn submission(
